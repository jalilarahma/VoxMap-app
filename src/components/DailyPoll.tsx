        ...
        <div className="text-center space-y-6 w-full max-w-lg">
          ...
          <div className="flex gap-2 justify-center flex-wrap">
            ...
            <button
              ...
              title="Snapchat"
            >
              <svg viewBox="0 0 512 512" width="22" height="22" fill="black">
                <path d="M256 32c-69 0-119 34-140 96-8 24-6 72-4 104-12 6-28 2-42-6-8-4-14-4-20 0-10 6-12 18-4 26 14 16 38 28 64 38-4 12-16 20-32 26-28 10-48 24-48 40 0 14 12 22 28 26 18 6 38 8 52 10 4 6 6 16 10 24 4 10 14 18 28 18 20 0 40-16 66-30 16-8 30-14 42-14s26 6 42 14c26 14 46 30 66 30 14 0 24-8 28-18 4-8 6-18 10-24 14-2 34-4 52-10 16-4 28-12 28-26 0-16-20-30-48-40-16-6-28-14-32-26 26-10 50-22 64-38 8-8 6-20-4-26-6-4-12-4-20 0-14 8-30 12-42 6 2-32 4-80-4-104C375 66 325 32 256 32z"/>
              </svg>
            </button>
          </div>
